...
uses
  helper.frame,
  helper.image, DataModule;

{$R *.fmx}

procedure TfrmPaises.Inicializar;
begin
  TbcPaises.TabIndex := 0;
end;

procedure TfrmPaises.VoltarInicio;
begin
  ChangeTabAction1.Tab := TabPaises;
  ChangeTabAction1.Execute;
end;

procedure TfrmPaises.LsvPaisesItemClick(const Sender: TObject; const AItem: TListViewItem);
var
  URLBandeira: String;
begin
...
procedure TfrmPaises.BtnVoltarClick(Sender: TObject);
begin
  Self.VoltarInicio;
end;
