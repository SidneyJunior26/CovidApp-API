...
uses
  ...
  FMX.TabControl, System.ImageList, FMX.ImgList, FMX.MultiView,FMX.Gestures,
  System.Actions, FMX.ActnList, FormPaises, FormMundo, FormSobre;
...
type
  TFrmPrincipal = class(TForm)
    ...
    TabPaises: TTabItem;
    LblCaption: TLabel;
    FrameMundo1: TFrmMundo;
    BtnSobre: TSpeedButton;
    FramePaises1: TFrmPaises;
    BtnAtualizar: TSpeedButton;
    FrameSobre1: TFrmSobre;
